...
return (
  ...
  <h1 className='headingh1'>NewsMania📰</h1>
 
  <form style={{textAlign:'center'}} onSubmit={handlesubmit}>

<div style={{display:'flex'}}>
<input style={{position:'sticky',top: '0',fontFamily:'cursive'}} placeholder='Search latest news...' className='query_input' type='text' ref={queryinputref}/>
